...
public:
    ...
    // Plantilla de método para ordenar el arreglo de rutas
    ...
    // Plantilla de método para imprimir rutas ordenadas según un criterio
    template<typename Comparator>
    void imprimirRutasOrdenadas(Comparator comp) {
        ordenarRutas(comp);
        imprimirRutas();
    }
};
...
int main() {
    ...
    sistemaRutasDouble.imprimirRutasOrdenadas(compararPorDistancia<double>);
    sistemaRutasInt.imprimirRutasOrdenadas(compararPorDistancia<int>);

    // Ordenar y imprimir las rutas por tiempo estimado
    cout << "\nRutas ordenadas por tiempo estimado:" << endl;
    sistemaRutasDouble.imprimirRutasOrdenadas(compararPorTiempo<double>);
    sistemaRutasInt.imprimirRutasOrdenadas(compararPorTiempo<int>);
